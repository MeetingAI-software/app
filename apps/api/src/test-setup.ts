...
delete process.env.MAX_LIVE_STREAM_CONNECTIONS;
delete process.env.MAX_LIVE_STREAM_CONNECTIONS_PER_USER;
delete process.env.MAX_LIVE_STREAM_CONNECTIONS_PER_MEETING;
